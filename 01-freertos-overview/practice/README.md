...
## 📝 Checklist
- [x] ตรวจสอบการติดตั้ง ESP-IDF
- [x] สร้างโปรเจกต์ใหม่สำเร็จ
- [x] Build และ Flash โปรแกรมสำเร็จ
- [x] ดู Serial Output ได้
- [x] สร้าง Task ขยั้นพื้นฐานได้
- [x] ทำความเข้าใจ Task lifecycle
