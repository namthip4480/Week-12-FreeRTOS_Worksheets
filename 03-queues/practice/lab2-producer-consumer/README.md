...
- เนื่องจากมี **Producer เพิ่มขึ้น** แต่ Consumer เท่าเดิม → Queue ถูกเติมเร็วขึ้น  
- Queue อาจ **เต็มบ่อยขึ้น** → ส่งผลให้บางข้อความ **drop** หรือ Task Producer ถูกบล็อกรอพื้นที่ว่าง  

---

#### 2. ในทดลองที่ 3 ระบบทำงานเป็นอย่างไร?

- ลดจำนวน Consumer → Queue ถูกเติมโดย Producer เร็วกว่า  
- บางครั้ง Queue เต็ม → ข้อความที่ส่งใหม่ถูก **drop**  
- Consumer ที่เหลือทำงานหนักขึ้น → อาจเกิด **bottleneck** และประสิทธิภาพระบบลดลง  

---

#### 3. Load Balancer แจ้งเตือนเมื่อไหร่?

- แจ้งเตือนเมื่อ **Queue มีการ overflow หรือ drop ข้อมูล**  
- เป็นสัญญาณว่าระบบไม่สามารถประมวลผลข้อความได้ทัน  
- สามารถปรับได้โดยเพิ่ม Consumer หรือขยายขนาด Queue
