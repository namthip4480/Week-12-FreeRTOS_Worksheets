...
|-------|-------------|----------------|--------------|----------------|------------|
| 1 (Normal) | 20 | 20 | 5 | 2 | 100% |
| 2 (Multiple Give) | 60 | 60 | 5 | 2 | 100% |
| 3 (Short Timeout) | 20 | 18 | 5 | 2 | 90% |
...
- Binary Semaphore สามารถ **ให้สูงสุด 1 ครั้งต่อเวลา**  
- หาก give หลายครั้งติดต่อกัน → semaphore จะ **ยังคงถูกถืออยู่เพียงครั้งเดียว**  
- Task Consumer ที่รออยู่จะ unblock **ครั้งเดียว**  

---

#### 2. ISR สามารถใช้ `xSemaphoreGive` หรือต้องใช้ `xSemaphoreGiveFromISR`?

- ใน ISR ต้องใช้ **`xSemaphoreGiveFromISR()`**  
- เพราะ ISR ทำงานใน context พิเศษ ต้องใช้ฟังก์ชันที่ **safe สำหรับ interrupt**  
- `xSemaphoreGive()` ใช้ได้เฉพาะ Task context เท่านั้น  

---

#### 3. Binary Semaphore แตกต่างจาก Queue อย่างไร?

| ฟังก์ชัน | Binary Semaphore | Queue |
|-----------|----------------|-------|
| เก็บข้อมูล | เพียง 0 หรือ 1 | สามารถเก็บหลาย item |
| ใช้สื่อสาร | ใช้สัญญาณระหว่าง Task หรือ Task-ISR | ใช้ส่งข้อมูลจริงระหว่าง Task |
| การจัดการ | ไม่มี FIFO ของ item | FIFO ของ item มีลำดับการรับส่ง |
| เหมาะกับ | Synchronization / Event signaling | Data passing / Message queue |
...
### สิ่งที่เรียนรู้:
- [x] หลักการทำงานของ Binary Semaphore
- [x] การใช้ Semaphore สำหรับ Task Synchronization
- [x] การสื่สารระหว่าง ISR และ Task
- [x] การใช้ Timer interrupt กับ Semaphore
- [x] การจัดการ Button interrupt
